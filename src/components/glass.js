...
const Glass = () => {
  ...
  return (
    <div className='items-center md:w-[80%] w-full flex flex-col z-20 bg-[#060c21]  rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-50 border border-blue-850 p-10 shadow-[inset_-1px_-1px_5px_#fff]'>
